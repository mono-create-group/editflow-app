// EditFlow Service Worker v20260819-18
const CACHE = 'editflow-20260819-18';
const LATEST_APP_URL = new URL('./editflow.html?app=20260819-18', self.registration.scope).href;
