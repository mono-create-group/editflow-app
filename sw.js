// EditFlow Service Worker v20260828-01
const CACHE = 'editflow-20260828-01';
const LATEST_APP_URL = new URL('./editflow.html?app=20260828-01', self.registration.scope).href;
