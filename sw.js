// EditFlow Service Worker v20260918-04
const CACHE = 'editflow-20260918-04';
const LATEST_APP_URL = new URL('./editflow.html?app=20260918-04', self.registration.scope).href;
