// EditFlow Service Worker v20260819-22
const CACHE = 'editflow-20260819-22';
const LATEST_APP_URL = new URL('./editflow.html?app=20260819-22', self.registration.scope).href;
