// EditFlow Service Worker v20260903-04
const CACHE = 'editflow-20260903-04';
const LATEST_APP_URL = new URL('./editflow.html?app=20260903-04', self.registration.scope).href;
