// EditFlow Service Worker v20260905-02
const CACHE = 'editflow-20260905-02';
const LATEST_APP_URL = new URL('./editflow.html?app=20260905-02', self.registration.scope).href;
