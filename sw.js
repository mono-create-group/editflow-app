// EditFlow Service Worker v20260818-15
const CACHE = 'editflow-20260818-15';
const LATEST_APP_URL = new URL('./editflow.html?app=20260818-15', self.registration.scope).href;
